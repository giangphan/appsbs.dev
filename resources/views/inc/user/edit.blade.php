    ...
    <div class="col-md-12 col-lg-12" id="ProductInfo">
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="row">
                 <form id="register_user" class="form-horizontal" role="form" method="POST" action="/user/{{ $user->id }}">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <div class="form-group{{ $errors->has('active') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="active">
                                ...
                                <option value="0" <?php if($user->active == 0) echo 'selected' ?>>Deactivate</option>
                            </select>
                        </div>
                    </div>
